    ...
    <>
      <div className="container">
        ...
        <div className="col-12">
          ...
          <p>Last updated: April 23, 2021</p>
          <p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to WannaJam.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to WannaJam, accessible from{' '}
                <a
                  href="www.wannaJam.com"
          ...
          <ul>
            <li>By email: sapirtomer1989@gmail.com</li>
          </ul>
        </div>
      </div>
    </>
